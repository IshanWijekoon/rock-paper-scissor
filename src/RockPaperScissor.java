...
public class RockPaperScissor {
	// all of the choices that a computer can
	...
	// playerChoice - is the choice made by the plater (i.e. rock, paper, or scissors)
	// this method will return the result of the game (i.e. computer win, plater win, draw)
